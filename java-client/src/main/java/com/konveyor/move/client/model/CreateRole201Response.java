...
public class CreateRole201Response {
  ...
  public CreateRole201Response id(String id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createRole201Response.id);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateRole201Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateRole201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateRole201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRole201Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
